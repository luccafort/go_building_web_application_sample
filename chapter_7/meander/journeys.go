...
var Journeys = []interface{}{
	...
	&j{Name: "ショッピング", PlaceTypes: []string{"department_store", "cafe", "clothing_store", "jewery_store", "shoe_store"}},
	&j{Name: "ナイトライフ", PlaceTypes: []string{"bar", "casino", "food", "night_club", "bar", "bar", "hospital"}},
